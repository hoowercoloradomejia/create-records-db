...
<body>
    ...
    <br/>
    <br/>
    <form action="create-disfraztotal.php" method="POST">
        ...
        <br/>
        <br/>
        Disfraz Guardado: <input value="<?php echo $name?>" />
        
                  <input value="<?php echo $genero?>" />
                  <input value="<?php echo $talla1?>" />
                  <input value="<?php echo $talla2?>" />
                  <input value="<?php echo $talla3?>" />  
